...
if (anu.action == 'add' && !mem.includes(herman.user.jid)) {
            ...
            if (anu.action == 'remove' && !mem.includes(herman.user.jid)) {
                ...
                out = `*Good Bye Brother* @${num.split('@')[0]}`
                goodbyeBut = [{buttonId:` `,buttonText:{displayText:'GoodBye'}, type:1}]
                goodbyeButt = { contentText: `${out}`, footerText: `*${time_wel} -  ${time_welc}* \n© _oggybotz_ 2022`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
